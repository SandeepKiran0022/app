...
import { BRAND_COLOR, SIDE_MENU_BOTTOM, SIDE_MENU_TOP } from '../ config/constants';
                ...
                <Content>
                    <View style={styles.topContainer}>
                        <View style={styles.innerView}>
                            ...
                            />
                            <View>
                                <Text style={styles.innerText}> Balakumar G V </Text>
...
const styles = StyleSheet.create({
    container          : {
        flex            : 1,
        backgroundColor : SIDE_MENU_BOTTOM,
